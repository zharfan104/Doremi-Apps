...
import 'package:doremi/tabs/musisi/yourEvent.dart';
import 'package:doremi/tabs/musisi/musicianPage.dart';

class HomeMusisi extends StatefulWidget {
  final int index;
  final int isLogin;
  ...
  _HomeMusisiState createState() => _HomeMusisiState();
}

class _HomeMusisiState extends State<HomeMusisi> with TickerProviderStateMixin {
