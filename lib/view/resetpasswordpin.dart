...
import 'package:izievent/view/passwordsuccess.dart';
        ...
        children: <Widget>[
          ...
          Container(            
            child: Align(
              ...
              child: Text('Enter 4 digits', style: TextStyle(
                fontSize: 39,
              ...
              child: Align(
                alignment: AlignmentDirectional.topStart,
                child: Text('recover pin', style: TextStyle(
                  fontSize: 39,
                  fontWeight: FontWeight.bold,
                  color: HexColor("C52127")
                ),),
          ...
          Container(       
            child: Align(
              alignment: AlignmentDirectional.topStart,
              child: Text("Recovery code is sent to your via sms no. *********455. Please enter code here", style: TextStyle(
                fontSize: 14,
          ...
          Center(
            child : FlatButton(
              ...
              child: Text('Cancel', style: TextStyle(color: HexColor("676767"), fontSize: 16, fontWeight: FontWeight.bold),),
            )
          ),
          SizedBox(height: 10,),
          Container(
